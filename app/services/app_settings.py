...
APP_SETTINGS_ENV_MAP = {
    ...
    "scheduler_autorun_import_delivery_enabled": "SCHEDULER_AUTORUN_IMPORT_DELIVERY_ENABLED",
...
def read_app_settings() -> AppSettingsRead:
    ...
    return AppSettingsRead(
        ...
        scheduler_autorun_import_delivery_enabled=settings.scheduler_autorun_import_delivery_enabled,
...
def update_app_settings(payload: AppSettingsUpdate) -> AppSettingsRead:
    ...
    env_updates = {
        ...
        "SCHEDULER_AUTORUN_IMPORT_DELIVERY_ENABLED": "true" if payload.scheduler_autorun_import_delivery_enabled else "false",
