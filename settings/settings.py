...
Discord = os.environ.get('DISCORD_CROSSPOSTING').lower() == 'true' if os.environ.get('DISCORD_CROSSPOSTING') else Discord
Tumblr = os.environ.get('TUMBLR_CROSSPOSTING').lower() == 'true' if os.environ.get('TUMBLR_CROSSPOSTING') else Tumblr
